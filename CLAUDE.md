...
3. **格式檢查**：「🔥 格式檢查要求」中的所有檢查項目
   1. **第一步**：立即建立 TODO 清單，列出「🔥 格式檢查要求」的 4 個檢查項目
   2. **第二步**：逐項執行格式檢查
   3. **禁止**：不可跳過或延後「🔥 格式檢查要求」
...
- [ ] **第一項 資訊查證：** 所有時間、營業時間已查證或標註「⚠️ 需確認」
- [ ] **第二項 連結檢查：** 所有 Google Maps 連結正確或標註「需實際查詢」
- [ ] **第三項 語言與排版規範** 根據「語言與排版規範」檢查並修復
- [ ] **第四項 格式檢查：** 執行 markdownlint 並修復所有錯誤
